...
def generate_launch_description(): 
    ...
    moveit_config = (
        ...
        .robot_description(file_path=os.path.join(get_package_share_directory("robotic_arm_description"), "urdf", "robotic_arm.urdf.xacro"))
    ...
    rviz_config = os.path.join(get_package_share_directory("robotic_arm_moveit"), "config", "moveit.rviz")
